...
public class PipeGenerator : MonoBehaviour
{
    ...
    private List<GameObject> pipes = new List<GameObject>(); // Ensure this is declared at the class level
    ...
    void GeneratePipes(int segments)
    {
        for (int i = 0; i < segments; i++)
        {
            ...
            pipes.Add(pipeSegment); // Ensure this line is inside the GeneratePipes method
        }
    }
}
